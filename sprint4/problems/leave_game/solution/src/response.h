...
namespace http_handler {
    ...
    class Response
    {
        ...
        static StringResponse MakeBadRequestJson();
        static StringResponse MakeBadRequestText();
        static StringResponse MakeNotFoundJson();
        static StringResponse MakeNotFoundText();
        static StringResponse MakeServerErrorText(std::string_view message);
    };
}
